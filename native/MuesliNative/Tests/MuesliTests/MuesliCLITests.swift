...
struct MuesliCLITests {
    ...
    func transcribeEnumsAcceptDocumentedValues() {
        ...
        #expect(TranscribeModel(argument: "whisper-hinglish") == .whisperHinglish)
        ...
        #expect(TranscribeModel.whisperHinglish.whisperKitModelName == ManagedASRModelPlans.hinglishWhisperKitModelName)
